...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    var showImg = $('<img src="http://otzsrcc8k.bkt.clouddn.com/static/photos/images/loading.gif"/>');

    var filename = progressNameCol.text();
    progressNameCol.html(Wrapper);

    if (!isImg) {
        showImg.attr('src', 'http://otzsrcc8k.bkt.clouddn.com/static/photos/images/default_file.png');
